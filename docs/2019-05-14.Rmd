...
Where did the United States of America and the United Kingdom go on the map?

```{r checkMapCountries}
t <- map.world[region %like% "USA" | region %like% "UK"]

kableExtra::kable(table(t$region), caption = "Number of polygons for specified country name strings") %>% kable_styling()
```
